...
namespace MK.Glow
{
    ...
    internal static class PipelineExtensions
    {
        ...
        internal static void Draw(this CommandBuffer cmd, List<RenderTargetIdentifier> destinations, Material material, int pass)
        {
        ...
        {
            return RenderTexture.GetTemporary(renderContext.width, renderContext.height, 16, format, RenderTextureReadWrite.Default, 1);
        }
    }
}